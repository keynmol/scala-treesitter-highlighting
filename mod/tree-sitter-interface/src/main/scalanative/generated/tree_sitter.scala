...
// object predef:
//   private[treesitter_native] trait CEnumU[T](using eq: T =:= UInt):
...
// object aliases:
//   import _root_.treesitter_native.enumerations.*
//   import _root_.treesitter_native.predef.*
//   import _root_.treesitter_native.aliases.*
//   import _root_.treesitter_native.structs.*
...
// @extern
// private[treesitter_native] object extern_functions:
//   import _root_.treesitter_native.enumerations.*
//   import _root_.treesitter_native.predef.*
//   import _root_.treesitter_native.aliases.*
//   import _root_.treesitter_native.structs.*
//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_child(self : Ptr[TSNode], child_index : uint32_t, __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_child_by_field_id(self : Ptr[TSNode], field_id : TSFieldId, __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_child_by_field_name(self : Ptr[TSNode], name : CString, name_length : uint32_t, __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_child_count(self : Ptr[TSNode]): uint32_t = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_descendant_count(self : Ptr[TSNode]): uint32_t = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_descendant_for_byte_range(self : Ptr[TSNode], start : uint32_t, end : uint32_t, __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_descendant_for_point_range(self : Ptr[TSNode], start : Ptr[TSPoint], end : Ptr[TSPoint], __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_end_byte(self : Ptr[TSNode]): uint32_t = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_end_point(self : Ptr[TSNode], __return : Ptr[TSPoint]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_eq(self : Ptr[TSNode], other : Ptr[TSNode]): Boolean = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_field_name_for_child(self : Ptr[TSNode], child_index : uint32_t): CString = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_first_child_for_byte(self : Ptr[TSNode], byte : uint32_t, __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_first_named_child_for_byte(self : Ptr[TSNode], byte : uint32_t, __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_grammar_symbol(self : Ptr[TSNode]): TSSymbol = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_grammar_type(self : Ptr[TSNode]): CString = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_has_changes(self : Ptr[TSNode]): Boolean = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_has_error(self : Ptr[TSNode]): Boolean = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_is_error(self : Ptr[TSNode]): Boolean = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_is_extra(self : Ptr[TSNode]): Boolean = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_is_missing(self : Ptr[TSNode]): Boolean = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_is_named(self : Ptr[TSNode]): Boolean = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_is_null(self : Ptr[TSNode]): Boolean = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_language(self : Ptr[TSNode]): Ptr[TSLanguage] = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_named_child(self : Ptr[TSNode], child_index : uint32_t, __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_named_child_count(self : Ptr[TSNode]): uint32_t = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_named_descendant_for_byte_range(self : Ptr[TSNode], start : uint32_t, end : uint32_t, __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_named_descendant_for_point_range(self : Ptr[TSNode], start : Ptr[TSPoint], end : Ptr[TSPoint], __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_next_named_sibling(self : Ptr[TSNode], __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_next_parse_state(self : Ptr[TSNode]): TSStateId = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_next_sibling(self : Ptr[TSNode], __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_parent(self : Ptr[TSNode], __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_parse_state(self : Ptr[TSNode]): TSStateId = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_prev_named_sibling(self : Ptr[TSNode], __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_prev_sibling(self : Ptr[TSNode], __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_start_byte(self : Ptr[TSNode]): uint32_t = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_start_point(self : Ptr[TSNode], __return : Ptr[TSPoint]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_string(self : Ptr[TSNode]): CString = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_symbol(self : Ptr[TSNode]): TSSymbol = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_node_type(self : Ptr[TSNode]): CString = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_parser_logger(self : Ptr[TSParser], __return : Ptr[TSLogger]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_parser_parse(self : Ptr[TSParser], old_tree : Ptr[TSTree], input : Ptr[TSInput]): Ptr[TSTree] = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_parser_set_logger(self : Ptr[TSParser], logger : Ptr[TSLogger]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_query_cursor_exec(self : Ptr[TSQueryCursor], query : Ptr[TSQuery], node : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_query_cursor_set_point_range(self : Ptr[TSQueryCursor], start_point : Ptr[TSPoint], end_point : Ptr[TSPoint]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_tree_cursor_copy(cursor : Ptr[TSTreeCursor], __return : Ptr[TSTreeCursor]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_tree_cursor_current_node(self : Ptr[TSTreeCursor], __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_tree_cursor_goto_first_child_for_point(self : Ptr[TSTreeCursor], goal_point : Ptr[TSPoint]): int64_t = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_tree_cursor_new(node : Ptr[TSNode], __return : Ptr[TSTreeCursor]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_tree_cursor_reset(self : Ptr[TSTreeCursor], node : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_tree_root_node(self : Ptr[TSTree], __return : Ptr[TSNode]): Unit = extern

//   private[treesitter_native] def __sn_wrap_treesitter_ts_tree_root_node_with_offset(self : Ptr[TSTree], offset_bytes : uint32_t, offset_extent : Ptr[TSPoint], __return : Ptr[TSNode]): Unit = extern
...
// object types:
//   export _root_.treesitter_native.structs.*
//   export _root_.treesitter_native.aliases.*
//   export _root_.treesitter_native.enumerations.*

// object all:
//   export _root_.treesitter_native.enumerations.TSInputEncoding
//   export _root_.treesitter_native.enumerations.TSLogType
//   export _root_.treesitter_native.enumerations.TSQuantifier
//   export _root_.treesitter_native.enumerations.TSQueryError
//   export _root_.treesitter_native.enumerations.TSQueryPredicateStepType
//   export _root_.treesitter_native.enumerations.TSSymbolType
//   export _root_.treesitter_native.enumerations.TSWasmErrorKind
//   export _root_.treesitter_native.aliases.TSFieldId
//   export _root_.treesitter_native.aliases.TSStateId
//   export _root_.treesitter_native.aliases.TSSymbol
//   export _root_.treesitter_native.aliases.int64_t
//   export _root_.treesitter_native.aliases.size_t
//   export _root_.treesitter_native.aliases.uint16_t
//   export _root_.treesitter_native.aliases.uint32_t
//   export _root_.treesitter_native.aliases.uint64_t
//   export _root_.treesitter_native.structs.TSInput
//   export _root_.treesitter_native.structs.TSInputEdit
//   export _root_.treesitter_native.structs.TSLanguage
//   export _root_.treesitter_native.structs.TSLogger
//   export _root_.treesitter_native.structs.TSLookaheadIterator
//   export _root_.treesitter_native.structs.TSNode
//   export _root_.treesitter_native.structs.TSParser
//   export _root_.treesitter_native.structs.TSPoint
//   export _root_.treesitter_native.structs.TSQuery
//   export _root_.treesitter_native.structs.TSQueryCapture
//   export _root_.treesitter_native.structs.TSQueryCursor
//   export _root_.treesitter_native.structs.TSQueryMatch
//   export _root_.treesitter_native.structs.TSQueryPredicateStep
//   export _root_.treesitter_native.structs.TSRange
//   export _root_.treesitter_native.structs.TSTree
//   export _root_.treesitter_native.structs.TSTreeCursor
//   export _root_.treesitter_native.structs.TSWasmEngine
//   export _root_.treesitter_native.structs.TSWasmError
//   export _root_.treesitter_native.structs.TSWasmStore
//   export _root_.treesitter_native.structs.wasm_engine_t
//   export _root_.treesitter_native.functions.ts_language_field_count
//   export _root_.treesitter_native.functions.ts_language_field_id_for_name
//   export _root_.treesitter_native.functions.ts_language_field_name_for_id
//   export _root_.treesitter_native.functions.ts_language_is_wasm
//   export _root_.treesitter_native.functions.ts_language_next_state
//   export _root_.treesitter_native.functions.ts_language_state_count
//   export _root_.treesitter_native.functions.ts_language_symbol_count
//   export _root_.treesitter_native.functions.ts_language_symbol_for_name
//   export _root_.treesitter_native.functions.ts_language_symbol_name
//   export _root_.treesitter_native.functions.ts_language_symbol_type
//   export _root_.treesitter_native.functions.ts_language_version
//   export _root_.treesitter_native.functions.ts_lookahead_iterator_current_symbol
//   export _root_.treesitter_native.functions.ts_lookahead_iterator_current_symbol_name
//   export _root_.treesitter_native.functions.ts_lookahead_iterator_delete
//   export _root_.treesitter_native.functions.ts_lookahead_iterator_language
//   export _root_.treesitter_native.functions.ts_lookahead_iterator_new
//   export _root_.treesitter_native.functions.ts_lookahead_iterator_next
//   export _root_.treesitter_native.functions.ts_lookahead_iterator_reset
//   export _root_.treesitter_native.functions.ts_lookahead_iterator_reset_state
//   export _root_.treesitter_native.functions.ts_node_edit
//   export _root_.treesitter_native.functions.ts_parser_cancellation_flag
//   export _root_.treesitter_native.functions.ts_parser_delete
//   export _root_.treesitter_native.functions.ts_parser_included_ranges
//   export _root_.treesitter_native.functions.ts_parser_language
//   export _root_.treesitter_native.functions.ts_parser_new
//   export _root_.treesitter_native.functions.ts_parser_parse_string
//   export _root_.treesitter_native.functions.ts_parser_parse_string_encoding
//   export _root_.treesitter_native.functions.ts_parser_print_dot_graphs
//   export _root_.treesitter_native.functions.ts_parser_reset
//   export _root_.treesitter_native.functions.ts_parser_set_cancellation_flag
//   export _root_.treesitter_native.functions.ts_parser_set_included_ranges
//   export _root_.treesitter_native.functions.ts_parser_set_language
//   export _root_.treesitter_native.functions.ts_parser_set_timeout_micros
//   export _root_.treesitter_native.functions.ts_parser_set_wasm_store
//   export _root_.treesitter_native.functions.ts_parser_take_wasm_store
//   export _root_.treesitter_native.functions.ts_parser_timeout_micros
//   export _root_.treesitter_native.functions.ts_query_capture_count
//   export _root_.treesitter_native.functions.ts_query_capture_name_for_id
//   export _root_.treesitter_native.functions.ts_query_capture_quantifier_for_id
//   export _root_.treesitter_native.functions.ts_query_cursor_delete
//   export _root_.treesitter_native.functions.ts_query_cursor_did_exceed_match_limit
//   export _root_.treesitter_native.functions.ts_query_cursor_match_limit
//   export _root_.treesitter_native.functions.ts_query_cursor_new
//   export _root_.treesitter_native.functions.ts_query_cursor_next_capture
//   export _root_.treesitter_native.functions.ts_query_cursor_next_match
//   export _root_.treesitter_native.functions.ts_query_cursor_remove_match
//   export _root_.treesitter_native.functions.ts_query_cursor_set_byte_range
//   export _root_.treesitter_native.functions.ts_query_cursor_set_match_limit
//   export _root_.treesitter_native.functions.ts_query_cursor_set_max_start_depth
//   export _root_.treesitter_native.functions.ts_query_delete
//   export _root_.treesitter_native.functions.ts_query_disable_capture
//   export _root_.treesitter_native.functions.ts_query_disable_pattern
//   export _root_.treesitter_native.functions.ts_query_is_pattern_guaranteed_at_step
//   export _root_.treesitter_native.functions.ts_query_is_pattern_non_local
//   export _root_.treesitter_native.functions.ts_query_is_pattern_rooted
//   export _root_.treesitter_native.functions.ts_query_new
//   export _root_.treesitter_native.functions.ts_query_pattern_count
//   export _root_.treesitter_native.functions.ts_query_predicates_for_pattern
//   export _root_.treesitter_native.functions.ts_query_start_byte_for_pattern
//   export _root_.treesitter_native.functions.ts_query_string_count
//   export _root_.treesitter_native.functions.ts_query_string_value_for_id
//   export _root_.treesitter_native.functions.ts_set_allocator
//   export _root_.treesitter_native.functions.ts_tree_copy
//   export _root_.treesitter_native.functions.ts_tree_cursor_current_depth
//   export _root_.treesitter_native.functions.ts_tree_cursor_current_descendant_index
//   export _root_.treesitter_native.functions.ts_tree_cursor_current_field_id
//   export _root_.treesitter_native.functions.ts_tree_cursor_current_field_name
//   export _root_.treesitter_native.functions.ts_tree_cursor_delete
//   export _root_.treesitter_native.functions.ts_tree_cursor_goto_descendant
//   export _root_.treesitter_native.functions.ts_tree_cursor_goto_first_child
//   export _root_.treesitter_native.functions.ts_tree_cursor_goto_first_child_for_byte
//   export _root_.treesitter_native.functions.ts_tree_cursor_goto_last_child
//   export _root_.treesitter_native.functions.ts_tree_cursor_goto_next_sibling
//   export _root_.treesitter_native.functions.ts_tree_cursor_goto_parent
//   export _root_.treesitter_native.functions.ts_tree_cursor_goto_previous_sibling
//   export _root_.treesitter_native.functions.ts_tree_cursor_reset_to
//   export _root_.treesitter_native.functions.ts_tree_delete
//   export _root_.treesitter_native.functions.ts_tree_edit
//   export _root_.treesitter_native.functions.ts_tree_get_changed_ranges
//   export _root_.treesitter_native.functions.ts_tree_included_ranges
//   export _root_.treesitter_native.functions.ts_tree_language
//   export _root_.treesitter_native.functions.ts_tree_print_dot_graph
//   export _root_.treesitter_native.functions.ts_wasm_store_delete
//   export _root_.treesitter_native.functions.ts_wasm_store_load_language
//   export _root_.treesitter_native.functions.ts_wasm_store_new
//   export _root_.treesitter_native.functions.ts_node_child
//   export _root_.treesitter_native.functions.ts_node_child_by_field_id
//   export _root_.treesitter_native.functions.ts_node_child_by_field_name
//   export _root_.treesitter_native.functions.ts_node_child_count
//   export _root_.treesitter_native.functions.ts_node_descendant_count
//   export _root_.treesitter_native.functions.ts_node_descendant_for_byte_range
//   export _root_.treesitter_native.functions.ts_node_descendant_for_point_range
//   export _root_.treesitter_native.functions.ts_node_end_byte
//   export _root_.treesitter_native.functions.ts_node_end_point
//   export _root_.treesitter_native.functions.ts_node_eq
//   export _root_.treesitter_native.functions.ts_node_field_name_for_child
//   export _root_.treesitter_native.functions.ts_node_first_child_for_byte
//   export _root_.treesitter_native.functions.ts_node_first_named_child_for_byte
//   export _root_.treesitter_native.functions.ts_node_grammar_symbol
//   export _root_.treesitter_native.functions.ts_node_grammar_type
//   export _root_.treesitter_native.functions.ts_node_has_changes
//   export _root_.treesitter_native.functions.ts_node_has_error
//   export _root_.treesitter_native.functions.ts_node_is_error
//   export _root_.treesitter_native.functions.ts_node_is_extra
//   export _root_.treesitter_native.functions.ts_node_is_missing
//   export _root_.treesitter_native.functions.ts_node_is_named
//   export _root_.treesitter_native.functions.ts_node_is_null
//   export _root_.treesitter_native.functions.ts_node_language
//   export _root_.treesitter_native.functions.ts_node_named_child
//   export _root_.treesitter_native.functions.ts_node_named_child_count
//   export _root_.treesitter_native.functions.ts_node_named_descendant_for_byte_range
//   export _root_.treesitter_native.functions.ts_node_named_descendant_for_point_range
//   export _root_.treesitter_native.functions.ts_node_next_named_sibling
//   export _root_.treesitter_native.functions.ts_node_next_parse_state
//   export _root_.treesitter_native.functions.ts_node_next_sibling
//   export _root_.treesitter_native.functions.ts_node_parent
//   export _root_.treesitter_native.functions.ts_node_parse_state
//   export _root_.treesitter_native.functions.ts_node_prev_named_sibling
//   export _root_.treesitter_native.functions.ts_node_prev_sibling
//   export _root_.treesitter_native.functions.ts_node_start_byte
//   export _root_.treesitter_native.functions.ts_node_start_point
//   export _root_.treesitter_native.functions.ts_node_string
//   export _root_.treesitter_native.functions.ts_node_symbol
//   export _root_.treesitter_native.functions.ts_node_type
//   export _root_.treesitter_native.functions.ts_parser_logger
//   export _root_.treesitter_native.functions.ts_parser_parse
//   export _root_.treesitter_native.functions.ts_parser_set_logger
//   export _root_.treesitter_native.functions.ts_query_cursor_exec
//   export _root_.treesitter_native.functions.ts_query_cursor_set_point_range
//   export _root_.treesitter_native.functions.ts_tree_cursor_copy
//   export _root_.treesitter_native.functions.ts_tree_cursor_current_node
//   export _root_.treesitter_native.functions.ts_tree_cursor_goto_first_child_for_point
//   export _root_.treesitter_native.functions.ts_tree_cursor_new
//   export _root_.treesitter_native.functions.ts_tree_cursor_reset
//   export _root_.treesitter_native.functions.ts_tree_root_node
//   export _root_.treesitter_native.functions.ts_tree_root_node_with_offset
