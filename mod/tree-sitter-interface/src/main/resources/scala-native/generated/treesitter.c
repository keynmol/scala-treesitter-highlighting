...
/* /1* uint32_t __sn_wrap_treesitter_ts_node_descendant_count(TSNode *self) { *1/ */
/* /1*  return ts_node_descendant_count(*self); *1/ */
/* /1* }; *1/ */
...
/* /1* TSSymbol __sn_wrap_treesitter_ts_node_grammar_symbol(TSNode *self) { *1/ */
/* /1*  return ts_node_grammar_symbol(*self); *1/ */
/* /1* }; *1/ */


/* /1* const char * __sn_wrap_treesitter_ts_node_grammar_type(TSNode *self) { *1/ */
/* /1*  return ts_node_grammar_type(*self); *1/ */
/* /1* }; *1/ */
...
/* /1* _Bool __sn_wrap_treesitter_ts_node_has_error(TSNode *self) { *1/ */
/* /1*  return ts_node_has_error(*self); *1/ */
/* /1* }; *1/ */


/* /1* _Bool __sn_wrap_treesitter_ts_node_is_error(TSNode *self) { *1/ */
/* /1*  return ts_node_is_error(*self); *1/ */
/* /1* }; *1/ */
...
/* /1* const TSLanguage * __sn_wrap_treesitter_ts_node_language(TSNode *self) { *1/ */
/* /1*  return ts_node_language(*self); *1/ */
/* /1* }; *1/ */
...
/* /1* TSStateId __sn_wrap_treesitter_ts_node_next_parse_state(TSNode *self) { *1/ */
/* /1*  return ts_node_next_parse_state(*self); *1/ */
/* /1* }; *1/ */
...
/* /1* void __sn_wrap_treesitter_ts_node_parent(TSNode *self, TSNode *____return) { *1/ */
/* /1*   TSNode ____ret = ts_node_parent(*self); *1/ */
/* /1*   memcpy(____return, &____ret, sizeof(TSNode)); *1/ */
/* /1* } *1/ */


/* /1* TSStateId __sn_wrap_treesitter_ts_node_parse_state(TSNode *self) { *1/ */
/* /1*  return ts_node_parse_state(*self); *1/ */
/* /1* }; *1/ */
...
/* /1* void __sn_wrap_treesitter_ts_tree_root_node_with_offset(const TSTree * self, uint32_t offset_bytes, TSPoint *offset_extent, TSNode *____return) { *1/ */
/* /1*   TSNode ____ret = ts_tree_root_node_with_offset(self, offset_bytes, *offset_extent); *1/ */
/* /1*   memcpy(____return, &____ret, sizeof(TSNode)); *1/ */
/* /1* } *1/ */
